...
public class BluetoothService {
    ...
    private ConnectedThread runner;
    ...
    private class ConnectedThread extends Thread {
        ...
        private byte[] mmBuffer = new byte[1024]; // mmBuffer store for the stream
        private static final int SEND_CODE = 1;
        private static final int QUIT_CODE = 2;
    ...
    public void start( BluetoothSocket sock ) {

        runner = new ConnectedThread( sock );
        runner.start();
    }

    public void send( String s ) {
        runner.write( s.getBytes() );
    }
}
